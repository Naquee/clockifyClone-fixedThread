    ...
    <>
      ...
      >
        ...
        <Flex mt="10px" justifyContent={"space-around"} maxW={350}>
          <img
            src="https://app.clockify.me/assets/ui-icons/master-card.svg"
            alt=""
          />
          <img src="https://app.clockify.me/assets/ui-icons/visa.svg" alt="" />
          <img
            src="https://app.clockify.me/assets/ui-icons/american-express.svg"
            alt=""
          />
          <img
            src="https://app.clockify.me/assets/ui-icons/union-pay.svg"
            alt=""
          />
          <img
            src="https://app.clockify.me/assets/ui-icons/discover.svg"
            alt=""
          />
          <img src="https://app.clockify.me/assets/ui-icons/jcb.svg" alt="" />
          <img
            src="https://app.clockify.me/assets/ui-icons/diners-club.svg"
            alt=""
          />
        </Flex>
        ...
        <Button w="280px" onClick={onOpen} mt="1rem" colorScheme="twitter">
          FINISH PAYMENT
        </Button>
        ...
        <Modal isOpen={isOpen} onClose={onClose}>
          ...
          <ModalContent>
            ...
            <ModalFooter>
              ...
              <Button colorScheme="blue" onClick={(e) => handlePay(e)}>
                Pay
              </Button>
            </ModalFooter>
          </ModalContent>
