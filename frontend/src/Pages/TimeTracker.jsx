...
const TimeTracker = () => {
  ...
  const getTasks = () => {
    axios
      .get("https://pure-cliffs-12633.herokuapp.com/tasks", {
        headers: {
  ...
  const stop = () => {
    ...
    setTag(undefined);
    axios
      .post(`https://pure-cliffs-12633.herokuapp.com/tasks/new`, payload, {
        headers: {
          Authorization: "Bearer " + getItem("token"),
        },
      })
    ...
    axios
      .post(`https://pure-cliffs-12633.herokuapp.com/project/new`, payload2, {
        headers: {
          Authorization: "Bearer " + getItem("token"),
        },
      })
  ...
  const handleDelete = (id) => {
    axios
      .delete(`https://pure-cliffs-12633.herokuapp.com/tasks/delete/${id}`, {
        headers: {
          Authorization: "Bearer " + getItem("token"),
        },
      })
              ...
              <ModalBody>
                <Flex direction={"row"}>
                  ...
                  <Flex direction={"column"} gap="3">
                    ...
                    <Tooltip
                      label="Upgrade for template"
                      placement="left"
                      height={"30px"}
                      bg={"white"}
                      color="black.400"
                    >
                      <Select placeholder="No Template"></Select>
                    </Tooltip>
                  </Flex>
                </Flex>
              </ModalBody>
                    ...
                    dataStore.map((task) => {
                      return (
                        <Tr fontSize={"0.9rem"}>
                          ...
                          <Td color={"gray.600"}>
                            {!task.billable ? "Not Billable" : "Billable"}
                          </Td>
                          ...
                          <Td>
                            <Menu>
                              ...
                              <MenuList>
                                <MenuItem>
                                  <Text onClick={() => handleDelete(task._id)}>
                                    Delete
                                  </Text>
                                </MenuItem>
                              </MenuList>
